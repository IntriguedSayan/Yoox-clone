              ...
              <Box>
                <Text style={{cursor:"pointer"}} onClick={onOpen}>LOGIN</Text>
                    <Modal isOpen={isOpen} onClose={onClose}>
                        ...
                        <Flex gap="3%" mb="1rem">
                            <Button size="lg" width="300px" colorScheme="facebook"><Icon as={FiFacebook} /></Button>
                        ...
                        <Box>
                        <Input variant="styled" size="lg" width="395px"m="2%"  backgroundColor="#f6f6f6" color="black" _placeholder={{ color: 'inherit' }}placeholder="EMAIl" /> 
                        <Input variant="styled" size="lg" width="395px"m="2%"  backgroundColor="#f6f6f6" color="black" _placeholder={{ color: 'inherit' }}placeholder="PASSWORD" /> 
                        </Box>    
                        ...
                        <Button size="lg" backgroundColor="#333333" width="400px" color="white" >REGISTER</Button>
